<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewTem.aspx.cs" Inherits="aspx_GoodsManagement_inside_newTem" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../css/NewTem-Content.css" />   
</head>
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="content">
            <div class="layui-breadcrumb" lay-separator=">" id="breadcrumb">
                ...
                <a><cite>新增运费模板</cite></a>
            </div>
            <div id="displaybox">
                <asp:Label ID="Label1" runat="server" Text="新增运费模板" Font-Bold="True" Font-Size="Medium" Font-Names="宋体" ForeColor="#000066"></asp:Label>

                <div class="layui-form showbox">
                    <div>
                        <asp:Label ID="Label22" runat="server" Text="Label">模板编号：</asp:Label>
                        <asp:TextBox ID="TnoText" runat="server" Height="20px"></asp:TextBox>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="radio" name="way1" title="自定义邮费" checked value="否" />&nbsp;&nbsp;
                        <input type="radio" name="way1" title="包邮" value="是" />
                    </div>
                    ...
                    <div class="buttonbox">
                        <hr id="hr" />
                        <div>
                            <asp:Button ID="SaveButton" runat="server" Text="保存并返回" CssClass="layui-btn layui-btn-sm layui-bg-blue" onclick="Save_Click"/>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
