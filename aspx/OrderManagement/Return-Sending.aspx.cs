...
public partial class aspx_OrderManagement_Return : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where Ostate='处理中' and o.Gno=g.Gno and o.Uno=ad.Uno");
        using (SqlConnection sqlCon = new SqlConnection(str))
        {
            sqlCon.Open();
    ...
    protected void Query_Click(object sender, EventArgs e)
    {
        ...
        {
            string sqlSelect1 = String.Format("select * from Orders o,Goods g,Address ad where Ostate='处理中' and o.Gno=g.Gno and o.Uno=ad.Uno and Ono='" + ono + "'and Ptime >='" + PtimeText1.Text.Trim() + "' and Ptime <='" + PtimeText2.Text.Trim() + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
        ...
        {
            string sqlSelect1 = String.Format("select * from Orders o,Goods g,Address ad where Ostate='处理中' and o.Gno=g.Gno and o.Uno=ad.Uno and Ono='" + ono + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect1, str); //创建DataAdapter数据适配器实例
        ...
        {
            string sqlSelect1 = String.Format("select * from Orders o,Goods g,Address ad where Ostate='处理中' and o.Gno=g.Gno and o.Uno=ad.Uno and Ptime >='" + PtimeText1.Text.Trim() + "' and Ptime <='" + PtimeText2.Text.Trim() + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect1, str); //创建DataAdapter数据适配器实例
    ...
    protected void Cancel_Click(object sender, EventArgs e)
    {
        ...
        if (upd == true)
        {
            Response.Write("<script>window.alert('取消成功!');location.href='OList-Finish.aspx';</script>");
        }
        else
        {
            Response.Write("<script>window.alert('取消失败!');location.href='Return-Sending.aspx';</script>");
        }
        //重新获取数据
    }
}