<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Return.aspx.cs" Inherits="aspx_OrderManagement_Return" EnableEventValidation="false"%>
...
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    <li><a href="Return.aspx" id="menuchecked">待退货</a></li>
                    <li><a href="Return-Sending.aspx">处理中</a></li>
                    <li><a href="Return-Finish.aspx">已退货</a></li>
                </ul>
            </div>
            <%--查询框--%>
            <div id="querybox">
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td height="80px">
                                ...
                                <br />
                                <asp:Button ID="ReturnButton" runat="server" Text="退货" CssClass="layui-btn layui-btn-xs layui-bg-red ReturnButton" Font-Size="Small" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' OnClientClick="return confirm('你确定要退货吗?')" onclick="Return_Click"/>         
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" height="15px" id="td3">
                            </td> 
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
