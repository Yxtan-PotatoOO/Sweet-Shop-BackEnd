<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateAdmin.aspx.cs" Inherits="aspx_AdminManagement_UpdateAdmin" EnableEventValidation="false"%>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../css/UpdateAdmin-Content.css" />
</head>
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <<div class="layui-body" id="content">
            ...
            <div id="displaybox">
                <asp:Label ID="Label1" runat="server" Text="修改管理员信息" Font-Bold="True" Font-Size="Medium" Font-Names="宋体" ForeColor="#000066"></asp:Label>
                    <div style="" class="layui-form showbox1">
                        <div>
                            <asp:Label ID="Label2" runat="server" Text="Label" Width="70px">用户号：</asp:Label>
                            <asp:Label ID="AnoLabel" runat="server" Font-Size="15px"></asp:Label>
                        </div>
                        <div>
                            <asp:Label ID="AnameLabel1" runat="server" Text="Label" Width="70px">用户名：</asp:Label>
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="AgroupText" runat="server" Height="20px"></asp:TextBox>                       
                        </div>
                    </div>
