<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OList-WaitSend.aspx.cs" Inherits="aspx_OrderManagement_OList" EnableEventValidation="false"%>
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="OList-WaitSend.aspx" id="menuchecked">待发货</a></li>
                    <li><a href="OList-Sending.aspx">处理中</a></li>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <tr">
                            ...
                            <td height="90px">
                                <asp:Button ID="DetailButton" runat="server" Text="详情" BackColor="White" Font-Size="Medium" ForeColor="Blue" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' onclick="Detail_Click" CssClass="DetailButton" />
                                <br />
                                <asp:Button ID="SendButton" runat="server" Text="发货" CssClass="layui-btn layui-btn-xs layui-bg-red SendButton" Font-Size="Small" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' OnClientClick="return confirm('你确定要发货吗?')" onclick="Send_Click"/>            
                            </td>
                        </tr>
                        <tr>
