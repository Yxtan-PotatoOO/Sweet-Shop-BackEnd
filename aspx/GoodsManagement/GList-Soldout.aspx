<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GList-Soldout.aspx.cs" Inherits="aspx_GoodsManagement_GList" EnableEventValidation="false"%>
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="GList-Soldout.aspx" id="menuchecked">已下架</a></li>
                </ul>
            </div>
            <%--查询框--%>
            <div id="querybox">
