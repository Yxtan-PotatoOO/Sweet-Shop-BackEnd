<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OList-Finish.aspx.cs" Inherits="aspx_OrderManagement_OList" EnableEventValidation="false"%>
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="OList-Finish.aspx" id="menuchecked">已完成</a></li>
                </ul>
            </div>
            <%--查询框--%>
            <div id="querybox">
