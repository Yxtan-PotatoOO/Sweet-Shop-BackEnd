...
public partial class aspx_AdminManagement_AdminDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string ano1 = Request["ano"];
            string sqlSelect = String.Format("select Ano,Aname,Asex,Aphone,Agroup,Astate,Ainfo,Aportrait from Admin where Ano='" + ano1 + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
    ...
    {
        string ano1 = Request["ano"];
        Response.Redirect("UpdateAdmin.aspx?ano1=" + ano1);
    }
    //取消
