<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OList-Sending.aspx.cs" Inherits="aspx_OrderManagement_OList" EnableEventValidation="false"%>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../css/OList-Navigation.css" />
    <link rel="stylesheet" type="text/css" href="../../css/OList-Content.css" />
...
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    <li><a href="OList.aspx">全部订单</a></li>
                    <li><a href="OList-WaitSend.aspx">待发货</a></li>
                    <li><a href="OList-Sending.aspx" id="menuchecked">处理中</a></li>
                    <li><a href="OList-Finish.aspx">已完成</a></li>
                </ul>
            </div>
            <%--查询框--%>
            <div id="querybox">
                <div class="querycondition">
                    <asp:Label ID="OnoLabel" runat="server" Text="订单号：" Font-Size="Medium"></asp:Label>
                    <asp:TextBox ID="OnoText" runat="server" Height="23px" Width="165px"></asp:TextBox>
                </div>
                <div class="querycondition">
                    <asp:Label ID="PtimeLabel" runat="server" Text="下单时间：" Font-Size="Medium"></asp:Label>
            ...
            <div id="displaybox">
                <asp:Repeater ID="Repeater1" runat="server">
                    <HeaderTemplate>
                        <table class="table">
                            <tr>
                                <td height="30px" id="td4">商品信息</td>
                                <td height="30px">单价</td>
                                <td height="30px">数量</td>
                                <td height="30px" id="td5">买家信息</td>
                                <td height="30px">实收款</td>
                                <td height="30px">操作</td>
                            </tr>
                            <tr>
                                <td colspan="6" id="td3" height="15px"></td>
                            </tr>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr id="tr">
                        ...
                        <tr">
                            <td height="90px" id="td4">
                                <asp:Image ID="GimageImage" runat="server" ImageUrl='<%# Eval("Gimage1","~/aspx/GoodsManagement/imgUploads/{0}")%>' Width="70px" Height="70px"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%# Eval("Gname")%>
                            ...
                            <td height="90px">
                                <asp:Button ID="DetailButton" runat="server" Text="详情" BackColor="White" Font-Size="Small" ForeColor="#3366CC" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' onclick="Detail_Click" CssClass="DetailButton" />
                                <br/>
                                <asp:Button ID="FinishButton" runat="server" Text="完成" CssClass="layui-btn layui-btn-xs layui-bg-red FinishButton" Font-Size="Small" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' onclick="Finish_Click"/>
                                
                                <asp:Button ID="CancelButton" runat="server" Text="取消" CssClass="layui-btn layui-btn-xs layui-bg-gray CancelButton" Font-Size="Small" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' onclick="Cancel_Click" OnClientClick="return confirm('你确定要取消发货吗?')"/>              
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" id="td3" height="15px">
                            </td> 
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
