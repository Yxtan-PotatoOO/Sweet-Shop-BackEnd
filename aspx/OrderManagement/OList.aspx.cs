...
public partial class aspx_OrderManagement_OList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno");
        using (SqlConnection sqlCon = new SqlConnection(str))
        {
            sqlCon.Open();
    ...
    protected void Query_Click(object sender, EventArgs e)
    {
        ...
        {
            string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno and Ono='" + ono + "'and Ptime >='" + PtimeText1.Text.Trim() + "' and Ptime <='" + PtimeText2.Text.Trim() + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect, str); //创建DataAdapter数据适配器实例
        ...
        {
            string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno and Ptime >='" + PtimeText1.Text.Trim() + "' and Ptime <='" + PtimeText2.Text.Trim() + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect, str); //创建DataAdapter数据适配器实例
        ...
        {
            string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno and Ono='" + ono + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect, str); //创建DataAdapter数据适配器实例
    ...
    protected void Delete_Click(object sender, EventArgs e)
    {
        ...
        string delSql = String.Format("delete from Orders where Ono='" + ono + "' and Uno='"+ uno +"'");
        OperateDataBase obd = new OperateDataBase();
        bool del = obd.ExceSql(delSql);
        if (del == true)
        {
            Response.Write("<script>window.alert('删除成功!');location.href='OList.aspx';</script>");
        }
        else
        {
            Response.Write("<script>window.alert('删除失败!');location.href='OList.aspx';</script>");
        }
    }
