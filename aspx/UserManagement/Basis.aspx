<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Basis.aspx.cs" Inherits="aspx_UserManagement_Basis" EnableEventValidation="false"%>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../css/Basis-Content.css" />
</head>
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="content">
            ...
            <div id="querybox">
                ...
                <div class="querycondition">
                    <asp:Label ID="UphoneLabel" runat="server" Text="手机号：" Font-Size="Medium"></asp:Label>
                    <asp:TextBox ID="UphoneText" runat="server" Height="26px" Width="155px"></asp:TextBox>
                </div>
                <div class="querycondition">
                    <asp:Label ID="UstateLabel" runat="server" Text="状态：" Font-Size="Medium"></asp:Label>
                    <asp:DropDownList ID="UstateDropDownList" runat="server" Height="30px" Width="155px"></asp:DropDownList>
                </div> 
