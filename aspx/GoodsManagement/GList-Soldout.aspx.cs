...
public partial class aspx_GoodsManagement_GList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select * from Goods where Gshelftime='下架'");
    ...
    protected void Query_Click(object sender, EventArgs e)
    {
        ...
        {
            string sqlSelect1 = String.Format("select * from Goods where Gname='" + GnameText.Text + "' and Gsort ='" + GsortDropDownList.SelectedItem.Text + "' and Gshelftime='下架'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
        ...
        {
            string sqlSelect1 = String.Format("select * from Goods where Gname='" + GnameText.Text + "' and Gshelftime='下架'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect1, str); //创建DataAdapter数据适配器实例
        ...
        {
            string sqlSelect1 = String.Format("select * from Goods where Gsort ='" + GsortDropDownList.SelectedItem.Text + "' and Gshelftime='下架'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect1, str); //创建DataAdapter数据适配器实例
    ...
    {
        GnameText.Text = null;
        Response.Redirect("GList-Soldout.aspx");
    }
    ...
    protected void Up_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>window.alert('上架失败!');location.href='GList-Soldout.aspx';</script>");
        }
    }
}