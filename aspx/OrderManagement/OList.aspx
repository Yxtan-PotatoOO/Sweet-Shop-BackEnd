<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OList.aspx.cs" Inherits="aspx_OrderManagement_OList" EnableEventValidation="false"%>
...
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    <li><a href="OList.aspx" id="menuchecked">全部订单</a></li>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td height="90px">
                                <asp:Button ID="DelButton" runat="server" Text="删除" onclick="Delete_Click" BackColor="White" Font-Size="Medium" ForeColor="#FF3300" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' OnClientClick="return confirm('你确定要删除吗?')" CssClass="DelButton" />
                                &nbsp;
                        ...
                        <tr>
                            <td colspan="7" id="td3" height="15px">
                            </td> 
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
