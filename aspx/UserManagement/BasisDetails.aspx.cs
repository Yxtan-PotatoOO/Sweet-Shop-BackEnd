...
public partial class aspx_UserManagement_BasisDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select * from Users where Uno='" + uno + "'");
        using (SqlConnection sqlCon = new SqlConnection(str))
        {
            sqlCon.Open();
    ...
    {
        string uno1 = Request["uno"];
        Response.Redirect("UpdateBasis.aspx?uno1=" + uno1);
    }
    //取消
