<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GList.aspx.cs" Inherits="aspx_GoodsManagement_GList" EnableEventValidation="false"%>
...
<body>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    <li><a href="GList.aspx" id="menuchecked">已上架</a></li>
                    <li><a href="GList-Storage.aspx">仓库</a></li>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td height="70px">
                                <asp:Button ID="DownButton" runat="server" Text="下架" onclick="Down_Click" BackColor="White" Font-Size="Medium" ForeColor="#FF3300" CommandArgument='<%# Eval("Gno") %>' OnClientClick="return confirm('你确定要下架吗?')" CssClass="DownButton" />
                                &nbsp;
