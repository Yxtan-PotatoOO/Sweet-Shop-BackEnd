<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BasisDetails.aspx.cs" Inherits="aspx_UserManagement_BasisDetails" EnableEventValidation="false"%>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../css/BasisDetails-Content.css" />
</head>
<body>
                    ...
                    <ItemTemplate>
                        <div class="layui-form showbox">
                            <div>
                                ...
                                <asp:Image ID="Image2" runat="server" Height="80px" Width="80px" Font-Size="15px" ImageUrl='<%#Eval("Uportrait","~/aspx/UserManagement/imgUploads/{0}") %>' />
                            </div>
                            <div>
                                <asp:Label ID="Label11" runat="server" Text="用户号：" Width="80px" Font-Size="15px"></asp:Label>
                                <asp:Label ID="Label12" runat="server" Font-Size="15px"><%# Eval("Uno") %></asp:Label>
                            </div>
                            <div>
                                <asp:Label ID="Label2" runat="server" Text="用户名：" Width="80px" Font-Size="15px"></asp:Label>
                                <asp:Label ID="Label7" runat="server" Font-Size="15px"><%# Eval("Uname")%></asp:Label>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <asp:Label ID="Label8" runat="server" Font-Size="15px"><%# Eval("Usex")%></asp:Label>
                            </div>                 
                            <div>
                                <asp:Label ID="Label1" runat="server" Text="手机号：" Width="80px" Font-Size="15px"></asp:Label>
                                <asp:Label ID="Label4" runat="server" Font-Size="15px"><%# Eval("Uphone")%></asp:Label>
                            </div> 

                            <div>
                                <asp:Label ID="Label3" runat="server" Text="注册时间：" Width="80px" Font-Size="15px"></asp:Label>
                                <asp:Label ID="Label9" runat="server" Font-Size="15px"><%# Eval("Uregtime")%></asp:Label>
                            </div>
                            <div>
                                <asp:Label ID="Label15" runat="server" Text="状态：" Width="80px" Font-Size="15px"></asp:Label>
                                <asp:Label ID="Label16" runat="server" Font-Size="15px"><%# Eval("Ustate")%></asp:Label>
                            </div>
                        </div> 
                    </ItemTemplate>
                </asp:Repeater>
