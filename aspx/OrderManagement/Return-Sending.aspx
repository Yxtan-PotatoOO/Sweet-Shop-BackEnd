<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Return-Sending.aspx.cs" Inherits="aspx_OrderManagement_Return" EnableEventValidation="false"%>
        ...
        <div class="layui-body" id="content">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="Return-Sending.aspx" id="menuchecked">处理中</a></li>
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td height="80px">
                                ...
                                <br />
                                <asp:Button ID="CancelButton" runat="server" Text="取消" CssClass="layui-btn layui-btn-xs layui-bg-red CancelButton" Font-Size="Small" CommandArgument='<%# Eval("Ono")+","+Eval("Uno")%>' onclick="Cancel_Click" OnClientClick="return confirm('你确定要取消退货吗?')"/> 
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" height="15px" id="td3"></td> 
