...
public partial class aspx_OrderManagement_OList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where Ostate='已完成' and o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno");
    ...
    protected void Query_Click(object sender, EventArgs e)
    {
        ...
        {
            string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where Ostate='已完成' and o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno and Ono='" + ono + "'and Ptime >='" + PtimeText1.Text.Trim() + "' and Ptime <='" + PtimeText2.Text.Trim() + "'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect, str); //创建DataAdapter数据适配器实例
        ...
        {
            string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno and Ptime >='" + PtimeText1.Text.Trim() + "' and Ptime <='" + PtimeText2.Text.Trim() + "' and Ostate='已完成'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect, str); //创建DataAdapter数据适配器实例
        ...
        {
            string sqlSelect = String.Format("select * from Orders o,Goods g,Address ad where o.Gno=g.Gno and o.Uno=ad.Uno and o.ADno = ad.ADno and Ono='" + ono + "' and Ostate='已完成'");
            using (SqlConnection sqlCon = new SqlConnection(str))
            {
                sqlCon.Open();
                SqlDataAdapter da = new SqlDataAdapter(sqlSelect, str); //创建DataAdapter数据适配器实例
