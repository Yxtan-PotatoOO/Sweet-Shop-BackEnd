...
public partial class aspx_UserManagement_AddressDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select a.Uno,u.Uname,ADcity,ADdetail,ADpostcode,ADrecipient,ADphone from Users u, Address a where a.Uno=u.uno and a.Uno='" + uno + "'");
        using (SqlConnection sqlCon = new SqlConnection(str))
        {
            sqlCon.Open();
